...
const aiRecommendation = {
  ...
  reason: 'Your current insulin stock (45 units) will deplete in approximately 5 days. CHC Warje has surplus inventory (620 units) and the shortest travel time among qualifying facilities.',
};
